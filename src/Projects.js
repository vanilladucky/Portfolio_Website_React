export default function Projects() {
    ...
    <section id='projects'>
        ...
        <div class='project-tile'>
          <a href="https://github.com/vanilladucky/simplysklearn" target='_blank' rel="noreferrer" class='project'> 
          ...
          <a href="https://github.com/vanilladucky/PyTorch_Guide" target='_blank' rel="noreferrer" class='project'> 
          ...
          <a href="https://www.kaggle.com/kimmik123" target='_blank' rel="noreferrer" class='project'>  
          ...
          <a href="https://github.com/vanilladucky/Self-Driving-Car" target='_blank' rel="noreferrer" class='project'>  
        ...
        <div class='projectbtn'>
          <a href='https://github.com/vanilladucky'target='_blank' rel="noreferrer" >
          Other projects
          </a>
        </div>
